    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator, django.core.validators.RegexValidator(message="Имя пользователя 'me' не допустимо для использования.", regex='^#[Mm][Ee]$')], verbose_name='Уникальный юзернейм')),
